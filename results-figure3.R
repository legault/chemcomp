...
png(filename = "Figure3.png", width = 4000, height = 4000, res = 300)
# Summary of results
par(mfrow = c(2, 2), mar = c(5, 5, 2, 2), cex.axis = 1.2)
# Day 22 (AO)
plot(NA, xlim = c(0, 150), ylim = c(0, 1), xaxt = "n", yaxt = "n", bty = "n", xlab = expression(paste("Conditioning intensity (density of ", italic("T. castaneum"), ")", sep = "")), ylab = "Proportion pupae", cex.lab = 1.5)
axis(1, seq(0, 150, 30), tcl = -.5)
axis(2, seq(0, 1, .2), tcl = -.5, las = 1)
mtext(side = 3, expression(paste("(a) Day 22 (", italic("CONF-CAST"), ")", sep = "")), adj = 0, cex = 1.5)
...
# Day 29 (A0)
plot(NA, xlim = c(0, 150), ylim = c(0, 1), xaxt = "n", yaxt = "n", bty = "n", xlab = expression(paste("Conditioning intensity (density of ", italic("T. castaneum"), ")", sep = "")), ylab = "Proportion adults", cex.lab = 1.5)
axis(1, seq(0, 150, 30), tcl = -.5)
axis(2, seq(0, 1, .2), tcl = -.5, las = 1)
mtext(side = 3, expression(paste("(b) Day 29 (", italic("CONF-CAST"), ")", sep = "")), adj = 0, cex = 1.5)
...
# Day 22 (OA)
plot(NA, xlim = c(0, 150), ylim = c(0.5, 1), xaxt = "n", yaxt = "n", bty = "n", xlab = expression(paste("Conditioning intensity (density of ", italic("T. confusum"), ")", sep = "")), ylab = "Proportion pupae", cex.lab = 1.5)
axis(1, seq(0, 150, 30), tcl = -.5)
axis(2, seq(0.5, 1, .1), tcl = -.5, las = 1)
mtext(side = 3, expression(paste("(c) Day 22 (", italic("CAST-CONF"), ")", sep = "")), adj = 0, cex = 1.5)
...
# Day 29 (OA)
plot(NA, xlim = c(0, 150), ylim = c(0.5, 1), xaxt = "n", yaxt = "n", bty = "n", xlab = expression(paste("Conditioning intensity (density of ", italic("T. confusum"), ")", sep = "")), ylab = "Proportion adults", cex.lab = 1.5)
axis(1, seq(0, 150, 30), tcl = -.5)
axis(2, seq(0.5, 1, .1), tcl = -.5, las = 1)
mtext(side = 3, expression(paste("(d) Day 29 (", italic("CAST-CONF"), ")", sep = "")), adj = 0, cex = 1.5)

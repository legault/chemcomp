...
# AO
plot(NA, xlim = c(0, 150), ylim = c(75, 275), xaxt = "n", yaxt = "n", bty = "n", cex.lab = 1.3, xlab = "Conditioning intensity", ylab = "Counts", cex.lab = 1.5)
...
points(Count.mod ~ jitter(Density, factor = 2), data = subset(data2, Type = "AO"), pch = 0, cex = 1.2)
densities <- c(0:150)
...
# OA
plot(NA, xlim = c(0, 150), ylim = c(75, 275), xaxt = "n", yaxt = "n", bty = "n", cex.lab = 1.3, xlab = "Conditioning intensity", ylab = "", cex.lab = 1.5)
axis(1, seq(0, 150, 30), tcl = -.5)
axis(2, seq(75, 275, 50), tcl = -.5, las = 1)
mtext(side = 3, c("(b) Eggs laid after 24 hours (OA)"), adj = 0, cex = 1.5)
points(Count.mod ~ jitter(Density, factor = 2), data = subset(data2, Type = "OA"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))

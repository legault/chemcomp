...
data22$prop <- data22$Pupae / (data22$Pupae + data22$Larvae)
## Create column for second proportion (Adults / (Adults + Pupae))
data29$prop <- data29$Adults / (data29$Adults + data29$Pupae)
...
points(prop.mod ~ jitter(Density), data = subset(data22, Type = "AO"), pch = 0, cex = 1.2)
densities <- c(0:150)
...
points(prop.mod ~ jitter(Density), data = subset(data22, Type = "OA"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ jitter(Density), data = subset(data29, Type = "AO"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ jitter(Density), data = subset(data29, Type = "OA"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))

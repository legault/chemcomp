...
data29$prop <- data29$Adults / data22$Total
...
points(prop.mod ~ jitter(Density, factor = 2), data = subset(data22, Type = "AO"), pch = 0, cex = 1.2)
densities <- c(0:150)
...
points(prop.mod ~ jitter(Density, factor = 2), data = subset(data22, Type = "OA"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ jitter(Density, factor = 2), data = subset(data29, Type = "AO"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ jitter(Density, factor = 2), data = subset(data29, Type = "OA"), pch = 0, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))

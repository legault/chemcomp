...
points(prop.mod ~ Density, data = subset(data22, Type = "AO"), pch = 16, cex = 1.2)
densities <- c(0:150)
...
points(prop.mod ~ Density, data = subset(data22, Type = "OA"), pch = 16, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ Density, data = subset(data29, Type = "AO"), pch = 16, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
...
points(prop.mod ~ Density, data = subset(data29, Type = "OA"), pch = 16, cex = 1.2)
densities <- c(0:150)
xvert <- c(densities, rev(densities))
